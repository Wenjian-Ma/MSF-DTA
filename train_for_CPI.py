...
for fold in range(1, 6):
    ...
    if ((not os.path.isfile(processed_data_file_train)) or
        ...
        best_roc = 0
        best_epoch = -1
        model_file_name = './data/processed/models/CPI/model_' + model_st + '_' + dataset + '_fold' + str(fold) + '.model'  # model
...
result_file_name = './data/processed/models/CPI/result_' + model_st + '_' + dataset + '.txt'  # result
